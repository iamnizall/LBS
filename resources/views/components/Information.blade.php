<html>
    ...
    <div class="container" style="background-size:contain;background-image:url(https://goindonesiatour.id/wp-content/uploads/2018/08/indonesia-map1.jpg)">
        ...
        <br>
        <p style="text-indent: 45px; text-align:justify">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis asperiores, et nisi error nam vitae, obcaecati nobis blanditiis facilis, aspernatur odio consequuntur iure totam vel quod culpa molestiae laborum aut? Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt eum quod similique accusamus mollitia, illum ipsam sed asperiores dolor possimus voluptas eaque voluptate vero repellat hic officia. Provident, porro quasi?
        </p>
    </div>
</html>